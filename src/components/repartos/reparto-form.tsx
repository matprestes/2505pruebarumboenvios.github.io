...
interface RepartoFormProps {
  ...
  empresasOptions: SelectOption[]; // Para empresa_id y empresa_despachante_id
      ...
      <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
        ...
        />
         <FormField
          ...
          render={({ field }) => (
            <FormItem>
              <FormLabel>Empresa (Destino/Servicio) (Opcional)</FormLabel>
              <Select onValueChange={field.onChange} value={field.value || undefined} defaultValue={field.value || undefined}>
                <FormControl>
                  <SelectTrigger>
        ...
        <FormField
          ...
          render={({ field }) => (
            <FormItem>
              <FormLabel>Empresa Despachante (Opcional)</FormLabel>
              <Select onValueChange={field.onChange} value={field.value || undefined} defaultValue={field.value || undefined}>
                <FormControl>
                  <SelectTrigger>
              ...
              <Popover>
                <PopoverTrigger asChild>
                  <FormControl>
                    ...
                    >
                      {field.value ? (
                        format(new Date(field.value + 'T00:00:00'), "PPP", { locale: es }) // Ensure correct parsing
                      ) : (
        ...
        <FormField
          ...
          render={({ field }) => (
            <FormItem>
              ...
              <FormControl>
                <Input placeholder="Ej: EMPRESA, INDIVIDUAL" {...field} value={field.value ?? ""} />
              </FormControl>
              <FormDescription>Descripción adicional del tipo de reparto.</FormDescription>
              <FormMessage />
            </FormItem>
          )}
        />

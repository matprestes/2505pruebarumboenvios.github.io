...
>(
  (
    ...
    const isMobileHookValue = useIsMobile() // Renamed to avoid conflict in Sidebar component
...
>(
  (
    ...
    const { isMobile: isMobileQuery, state, openMobile, setOpenMobile } = useSidebar()
    ...
    // Render mobile version (Sheet) only on the client after mount
    if (isClient && isMobileQuery) {
      return (
    ...
    // Render desktop version for SSR and initial client render, or if not mobile on client
    return (
      <div
        ref={ref}

...
export function TipoEnvioForm({ onSubmit, initialData, onCancel, isSubmitting }: TipoEnvioFormProps) {
  ...
  const entityType: EntityType = 'tipo_envio';
      ...
      <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
        ...
        <div className="flex justify-end space-x-2">
          ...
          <Button type="submit" disabled={isSubmitting}>
            {isSubmitting ? "Guardando..." : (initialData ? "Guardar Cambios" : "Crear Tipo de Envío")}
          </Button>
        </div>
      </form>
    </Form>

...
export function TipoRepartoForm({ onSubmit, initialData, onCancel, isSubmitting }: TipoRepartoFormProps) {
  ...
  const entityType: EntityType = 'tipo_reparto';
      ...
      <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
        ...
        <div className="flex justify-end space-x-2">
          ...
          <Button type="submit" disabled={isSubmitting}>
            {isSubmitting ? "Guardando..." : (initialData ? "Guardar Cambios" : "Crear Tipo de Reparto")}
          </Button>
        </div>
      </form>
    </Form>

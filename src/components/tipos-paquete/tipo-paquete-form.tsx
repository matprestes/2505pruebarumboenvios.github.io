...
export function TipoPaqueteForm({ onSubmit, initialData, onCancel, isSubmitting }: TipoPaqueteFormProps) {
  ...
  const entityType: EntityType = 'tipo_paquete';
      ...
      <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
        ...
        <div className="flex justify-end space-x-2">
          ...
          <Button type="submit" disabled={isSubmitting}>
            {isSubmitting ? "Guardando..." : (initialData ? "Guardar Cambios" : "Crear Tipo de Paquete")}
          </Button>
        </div>
      </form>
    </Form>

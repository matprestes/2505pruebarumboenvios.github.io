...
export async function addTipoEnvioAction(
  ...
  const supabase = createClient();
  // id_tipo_envio and created_at are auto-generated by DB
  ...
  const validatedFields = tipoEnvioSchema
    .omit({ id_tipo_envio: true, created_at: true })
...
export async function updateTipoEnvioAction(
  ...
  const supabase = createClient();
  // Exclude created_at and id_tipo_envio from update payload

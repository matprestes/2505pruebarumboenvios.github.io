...
import { getTipoServicioColumns } from "@/components/tipos-servicio/columns";
import { TipoServicioForm } from "@/components/tipos-servicio/service-type-form";
...
const initialTiposServicio: TipoServicio[] = [
  ...
  },
  {
    ...
    created_at: new Date().toISOString(),
    tarifas_servicio: [
      { id_tarifa_servicio: generateId(), id_tipo_servicio: "", hasta_km: 3.0, precio: 600.00, created_at: new Date().toISOString() },
      { id_tarifa_servicio: generateId(), id_tipo_servicio: "", hasta_km: 7.0, precio: 1000.00, created_at: new Date().toISOString() },
    ],
  },
  {
    id_tipo_servicio: generateId(),
